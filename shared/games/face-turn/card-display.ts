...
export const BOSS_DISPLAY: readonly BossCardDisplay[] = [
	...
	},
	{
		...
		flavorText: "The house always wins. Luckily, I run it.",
		lore: "",
...
export const CREW_DISPLAY: readonly CrewCardDisplay[] = [
	// strikers
	{
		...
		effectText: {
			revealed:
				"I deal 10 damage to an enemy Boss. If my partner Crew is face-up, deal 20 damage instead.",
	...
	},
	{
		...
		class: "striker",
		effectText: {
			revealed: "Discard 2. If you do, I deal 25 damage to an enemy Boss.",
		},
	...
	},
	{
		...
		class: "striker",
		effectText: {
			revealed: "I deal 20 piercing damage to an enemy Boss.",
	...
	},
	{
		...
		effectText: {
			revealed:
				"Discard 4. If you do, I do an unstoppable Strike on an enemy Crew. If you have successfully called a bluff this game, discard 2 instead.",
		},
	...
	},
	{
		...
		name: "Wolfman",
		class: "striker",
		effectText: { revealed: "I deal 30 damage to an enemy Boss." },
	...
	},
	{
		...
		effectText: {
			revealed:
				"If my Boss has any Armor, I give it 30 more Armor. If my Boss has no Armor, steal 1 Cash from an enemy instead.",
		},
	...
	},
	{
		...
		class: "defender",
		effectText: {
			revealed: "I deal 5 damage to all enemy Bosses.",
	...
	},
	{
		...
		class: "defender",
		effectText: {
			revealed: "I give 5 Armor to all allied Bosses.",
	...
	},
	{
		...
		effectText: {
			...
			passive: "At the start of your turn, your Boss gains 5 Armor.",
		},
...
export const MOVE_DISPLAY: readonly MoveCardDisplay[] = [
	...
	},
	{
		...
		moveType: "active",
		effectText:
			"At the start of your turn, deal 5 damage to your Boss. Then gain 1 Cash.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	// burst moves
	{
		...
		baseCost: 4,
		moveType: "burst",
		effectText: "Set an allied Boss's HP to 1. You gain 7 Cash and draw 3.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		baseCost: 4,
		moveType: "burst",
		effectText: "Heal an allied Boss for 20 HP. You gain 3 Cash.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		moveType: "burst",
		effectText:
			"Deal 10 damage to an enemy Boss. If the team has a face-up Striker, deal 20 damage instead.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		moveType: "burst",
		effectText:
			"You discard any number of cards from your hand. Deal 5 damage to an enemy Boss for each.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		baseCost: 1,
		moveType: "burst",
		effectText: "Deal 10 damage to an enemy Boss.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		moveType: "slow",
		effectText:
			"Deal 20 damage to an enemy Boss. If you have successfully called a bluff this game, this costs 0 Cash instead.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		baseCost: 3,
		moveType: "slow",
		effectText: "Deal 25 damage to an enemy Boss.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		moveType: "slow",
		effectText:
			"Turn one of your Crew face-up. If you do, deal 25 damage to an enemy Boss.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		baseCost: 2,
		moveType: "slow",
		effectText: "Deal 15 piercing damage to an enemy Boss.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
	...
	},
	{
		...
		baseCost: 6,
		moveType: "slow",
		effectText: "Deal 35 damage to an enemy Boss.",
		flavorText: "",
		lore: "",
		synergyIds: [],
	},
