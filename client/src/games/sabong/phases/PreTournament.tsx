		...
		<div className="flex flex-col min-h-screen bg-bg">
			...
			<div className="flex flex-col gap-3 px-5 pt-6 pb-4 border-b border-border">
				...
				<p className="text-xs text-white/30">
					Who wins the whole tournament? Correct pick earns a bonus at the end.
				</p>
			...
			{pickId && (
				<div className="px-4 pt-3">
					<span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-[10px] font-bold text-orange-400 uppercase tracking-widest">
	...
	return (
		<div className="flex flex-col min-h-screen bg-bg px-8 py-8 gap-8">
			<div className="flex items-end justify-between">
				<div className="flex flex-col gap-1">
					...
					<p className="text-white/40 text-sm mt-1">
						Pick your tournament champion on your phone
					</p>
				</div>
			...
			<div className="flex flex-wrap gap-2">
				{players.map((p) => {
					const locked = sabong.players[p.id]?.bracketPickLocked ?? false;
					return (
						<div
							key={p.id}
							className={cn(
