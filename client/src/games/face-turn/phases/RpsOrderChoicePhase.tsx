...
// only reached on a real rock-paper-scissors win — ties are settled
// server-side without an interactive choice (see beginRpsOrderChoice on
// the server), so the winner here always has a genuine free pick.
